...
def cleStart():
	...
	v_lst=(
		"autorun.log","p2p_packet_info.txt","packet_info.txt","profile.txt","stdout","syslog","syserr",
		"usage.txt","VERSION.txt","DEV_LOG.log","svside_log.txt","svside_protection_logs.txt","mob_count","*.core"
	)
	szPWD=os_getcwd()
